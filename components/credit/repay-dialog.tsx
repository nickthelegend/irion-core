        ...
        <div className="space-y-4 py-2">
          ...
          {success && txHash && (
            <div className="bg-green-500/10 border border-green-500/20 rounded-xl px-4 py-3 text-xs text-green-400 font-mono space-y-1">
              ...
              <p>TX: <a href={`https://lora.algokit.io/testnet/transaction/${txHash}`} target="_blank" rel="noopener noreferrer" className="underline hover:text-green-300 transition-colors">{txHash.slice(0, 10)}...{txHash.slice(-8)}</a></p>
            </div>
          )}
        </div>
