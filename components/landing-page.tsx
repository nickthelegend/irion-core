            ...
            <main className="relative z-10 min-h-screen flex flex-col items-center justify-center pt-24 overflow-hidden">
                ...
                <div className="w-full max-w-[1400px] px-6 flex flex-col items-center relative z-20">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <Link href="/pools" className="bg-primary px-12 py-5 rounded-2xl font-black text-xl text-black hover:scale-[1.02] active:scale-[0.98] transition-all min-w-[280px] shadow-[0_0_30px_rgba(0,202,150,0.3)] font-mono uppercase tracking-tighter flex items-center justify-center">
                            LAUNCH_INTERFACE
                        </Link>
                    </div>
                </div>
                ...
                <div className="marquee-container">
                    <div className="marquee-content flex gap-20 items-center">
                        <div className="flex gap-8 items-center">
                            ...
                            <span className="text-white/60 font-mono text-sm uppercase tracking-tighter whitespace-nowrap">LOCKED_VAL: 4,200,540</span>
                        </div>
                    </div>
                </div>
            </footer>
